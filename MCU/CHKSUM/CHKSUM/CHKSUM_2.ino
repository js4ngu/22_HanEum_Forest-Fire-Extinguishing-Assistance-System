...
void loop() {
    if (state == GPS1) {
        ...
        if ((sensReady[0] && sensReady[1] && sensReady[2] && sensReady[3] && sensReady[4]) == 0) {
            ...
            reGPSflag[0] = 1;   reGPSflag[1] = 1;   reGPSflag[2] = !;
            sensReady[0] = 0;   sensReady[1] = 0;   sensReady[2] = 0;    sensReady[3] = 0;   sensReady[4] = 0;
            reSensingFlag = 0;
            state = TX;
        }
    }
